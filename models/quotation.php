...
class Quotation{
    ...
    public static function get($QID){
        ...
        $sql = "SELECT Qc.QID , Qc.date AS date_order , Qc.Name AS Staff, Qc.CName AS customer ,Payment_Terms.Terms , Qc.detail 
    ...
    public static function Add($QID,$date_order,$Staff,$customer,$Payment_Type,$detail)
    {
        ...
        require("connection_connect.php");
        $sql ="INSERT INTO Quotation(QID,date_order,Staff,custer,Terms,detail) VALUES 
    ...
    public static function update($QID,$date_order,$Staff,$customer,$Payment_Type,$detail)
    {
        ...
        require("connection_connect.php");
        //echo $extra_color ; 
        $sql = "UPDATE Quotation SET QID = '$QID' , date_order = '$date_order',Staff = '$Staff',customer = '$customer',Terms = '$Payment_Type',detail = '$detail' 
        WHERE QID = '$QID' " ;
        $result=$conn->query($sql);
        //echo $extra_color ; 
        require("connection_close.php");
