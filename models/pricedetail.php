...
class price_detail{
    ...
    public function __construct($PriceDetailID,$Name,$ColorID,$จำนวนเริ่มต้น,$จำนวนสุดท้าย,$price,$สกรีนเพิ่มสีละ)
    {
    ...
    public static function getAll(){
        ...
        $sql ="SELECT Price_detail.PriceDetailID,Product.Name,Price_detail.ColorID,Price_detail.จำนวนเริ่มต้น,Price_detail.จำนวนสุดท้าย,Price_detail.price,Price_detail.สกรีนเพิ่มสีละ 
        ...
        while($my_row=$result->fetch_assoc())
        {
            ...
            $pricedetailList[]= new price_detail($PriceDetailID,$Name,$ColorID,$จำนวนเริ่มต้น,$จำนวนสุดท้าย,$price,$สกรีนเพิ่มสีละ);
        }
