...
class price_detail{
    ...
    public function __construct($Name,$จำนวนเริ่มต้น,$จำนวนสุดท้าย,$price,$สกรีนเพิ่มสีละ)
    {
        $this->Name = $Name;
    ...
    public static function getAll(){
        ...
        while($my_row=$result->fetch_assoc())
        {
            ...
            $pricedetailList[]= new price_detail($Name,$จำนวนเริ่มต้น,$จำนวนสุดท้าย,$price,$สกรีนเพิ่มสีละ);
        }
